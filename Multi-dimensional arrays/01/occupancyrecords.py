"""
You've been tasked with managing an apartment building's occupancy records. The provided code is supposed to print
all unoccupied apartments on each floor. Unfortunately, it is currently not working as intended. 
...
for floor in building:
    for apt in floor:
        if apt[1] == False:  # Checking occupancy status
